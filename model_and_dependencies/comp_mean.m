...
% matrix, Kd.
% => See notes from 11 Mar 2020 for potentially improved implementation
%
% Input:
...
if (p == -1) | (p == 1)
    if (Grid.Nx == Grid.N) || (Grid.Ny == Grid.N) % 1D
        ...
        else                 % x-direction: assmed row vector
